...
import CataSetDesktop from "../Layouts/Cataset/Desktop";
import CataSetMobile from "../Layouts/Cataset/Mobile";
...
function Cataset() {
  ...
  return (
    <div>
      <PageTitle title="Data Kategori Barang" />
      <motion.div
