...
const SidebarMobile = ({items}) => {
    ...
    return (
        <div className="bg-white w-64 min-h-screen inset-0 flex flex-col shadow-xl">
                    ...
                    ? (
                        <div>
                            <button
                                ...
                                isActive
                                    ? "gray"
                                    : "red"}-600 transition duration-300 hover:text-red-600 `}
                                ...
                                <div
                                    ...
                                    isActive
                                        ? "w-0 "
                                        : "w-2.5"} h-full transition-all duration-300 ${
                                    isActive
                                        ? "group-hover:w-2.5"
                                        : ""}`}/>
                            </button>
