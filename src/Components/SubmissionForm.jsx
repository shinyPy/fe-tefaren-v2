...
const SubmissionForm = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="bg-blue-700 shadow-md shadow-blue-700 rounded-lg p-4">
    <label className="block mb-4">
      <span className="text-white">Nomor WhatsApp:</span>
      <input
        type="text"
        name="nomor_wa"
    ...
    <label className="block mb-4">
      <span className="text-white">Alasan Peminjaman:</span>
      <textarea
    ...
    <label className="block mb-4">
      <span className="text-white">Tanggal Peminjaman:</span>
      <input
        type="date"
    ...
    <label className="block mb-4">
      <span className="text-white">Lama Peminjaman:</span>
      <input
        type="text"
    ...
    {/* Details Barang */}
    <label className="block mb-4">
      <span className="text-white">Details Barang:</span>
      <Select
  ...
  <div className=" w-7/12">
    ...
    <h1 className=' px-8 -translate-y-10 text-2xl font-semibold tracking-widest text-gray-700 capitalize'>silahkan isi form berikut untuk mengajukan permohonan</h1>
    </center>
  </div>
  </div>
  </div>
