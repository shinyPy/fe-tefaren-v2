...
import CataSetAddModalMobile from "../../Modal/Cataset/CatasetAddModalMobile";
import CatasetModalMobile from "../../Modal/Cataset/CatasetModalMobile";
  ...
  return (
    <div ref={sidebarRef}>
      ...
      <div className="mt-16 px-2 py-4 min-h-screen w-screen">
        <StepNav steps={steps} onSelectStep={handleStepSelect} Name="Data Kategori"/>
