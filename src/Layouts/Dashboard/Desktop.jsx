      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const countPenggunaResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-pengguna', {
              headers: {
            ...
            const countTipePenggunaResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-tipepengguna', {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
            ...
            const countTipeBarangResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-tipebarang', {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
            
            const countBarangResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-barang', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
            ...
            const countPermohonanResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-permohonan', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
              ...
              const countPeminjamanResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-peminjaman', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
              ...
              const countPengembalianResponse = await axios.get('http://jp.tky.1.paladinsrv.com:25932/api/count-pengembalian', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
