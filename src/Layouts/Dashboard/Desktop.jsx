      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const countPenggunaResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-pengguna', {
              headers: {
            ...
            const countTipePenggunaResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-tipepengguna', {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
            ...
            const countTipeBarangResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-tipebarang', {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
            
            const countBarangResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-barang', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
            ...
            const countPermohonanResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-permohonan', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
              ...
              const countPeminjamanResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-peminjaman', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
              ...
              const countPengembalianResponse = await axios.get('https://shiniya.000webhostapp.com/api/count-pengembalian', {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
