    ...
    try {
      ...
      if (responseData.success === true) {
        ...
        Swal.fire({
          icon: "error",
          title: "Error!",
          text: "Mohon Periksa kembali Nomor Induk / Email dan Sandi anda",
        });
      ...
      Swal.fire({
        icon: "error",
        title: "Login Error",
        text: "Terjadi Kesalahan pada saat login",
      });
    }
  };
      ...
      >
        <div className="w-1/2 p-4 flex justify-center items-center">
          <form onSubmit={handleLogin}>
            <h1 className="text-3xl font-semibold opacity-75 text-center uppercase tracking-widest">
              LOGIN
            </h1>
