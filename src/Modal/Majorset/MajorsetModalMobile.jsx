    ...
    try {
      ...
      if (result.status >= 200 && result.status < 300) {
        ...
        Swal.fire({
          ...
          text: "Data Jurusan telah berhasil dihapus.",
        });
      } else {
    ...
    >
      ...
      >
        <div className="mb-4 flex w-full justify-center">
          <span className="text-2xl px-5 py-2.5 rounded-full bg-gray-700 text-white">
            {rowData.NO}
          </span>
          <h1 className="text-lg tracking-widest rounded-l-lg text-gray-700 font-semibold px-5 py-2.5">
            Detail Jurusan
          </h1>
        </div>
...
export default MajorsetModalMobile;
